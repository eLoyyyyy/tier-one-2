        ...
        if ( is_archive() && !is_tax() && !is_category() && !is_tag() ) {
            ...
            if ( is_day() ) {
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        ...
                        <a itemprop="item" class="breadcrumb grey-text text-lighten-1 archive-month" href="' . get_month_link( get_the_time('Y'), get_the_time('m') ) . '" title="' . get_the_time('M') . '"><span itemprop="name">' . get_the_time('M') . ' Archives</span></a>
                    </span>';

                // Day display
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="4" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4 archive-day"><span itemprop="name"> ' . get_the_time('jS') . ' ' . get_the_time('M') . ' Archives</span></a>
                    </span>';
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="3" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4 archive-month" title="' . get_the_time('M') . '"><span itemprop="name">' . get_the_time('M') . ' Archives</span></a>
                    </span>';
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="2" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4" title="' . get_the_time('Y') . '"><span itemprop="name">' . get_the_time('Y') . ' Archives</span></a>
                    </span>';
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <meta itemprop="position" content="2" />
                    <a itemprop="item" class="breadcrumb grey-text text-darken-4 is-archive"><span itemprop="name">' . post_type_archive_title() . '</span></a>
                 </span>';
            ...
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="3" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4"><span itemprop="name">' . $custom_tax_name . '</span></a>
                    </span>';
            ...
            if(!empty($last_category)) {
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="3" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4" title="' . get_the_title() . '"><span itemprop="name">' . get_the_title() . '</span></a>
                    </span>';
            ...
            // Else if post is in a custom taxonomy
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="3" />
                        <a itemprop="item" class="breadcrumb grey-text text-lighten-1" href="' . $cat_link . '" title="' . $cat_name . '"><span itemprop="name">' . $cat_name . '</span></a>
                    </span>';
            ...
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="2" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4"><span itemprop="name">' . single_cat_title('', false) . '</span></a>
                    </span>';
            ...
            if( $post->post_parent ){
                ...
                echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                        <meta itemprop="position" content="2" />
                        <a itemprop="item" class="breadcrumb grey-text text-darken-4"><span itemprop="name">' . get_the_title() . '</span></a>
                    </span>';
            ...
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <meta itemprop="position" content="2" />
                    <a itemprop="item" class="breadcrumb grey-text text-darken-4"><span itemprop="name">' . $get_term_name . '</span></a>
                </span>';
            ...
            echo '<span itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                    <meta itemprop="position" content="2" />
                    <a itemprop="item" class="breadcrumb grey-text text-darken-4" title="' . $userdata->display_name . '"><span itemprop="name">' . 'Author: ' . $userdata->display_name . '</span></a>
                </span>';
